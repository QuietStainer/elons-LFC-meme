!(function () {
  "use strict";
  const e = (e, t, n) => {
      (e instanceof NodeList ? e : [e]).forEach((e) =>
        e.addEventListener(t, (t) => n(t, e))
      );
    },
    t = (e, t) => {
      r(e, t, "toggle");
    ...
    r = (e, t, n) => {
      const o = t.split(" ");
      (e instanceof NodeList ? e : [e]).forEach((e) =>
        e.classList[n].apply(e.classList, o)
      );
    };
  let i = null,
    c = 2;
  const s = () => {
      ...
      "enabled" !== e ||
        t < 2 ||
        ((i = document.querySelector(".nv-index-posts .posts-wrapper")),
        null !== i &&
          imagesLoaded(i, () => {
    ...
    a = () => {
      "enabled" === NeveProperties.infScroll &&
          ...
          new IntersectionObserver((o) => {
            ...
            const r = setInterval(() => {
              const n = e.getBoundingClientRect(),
                { top: o, left: i, right: c, bottom: s } = n,
                { innerWidth: a, innerHeight: l } = window;
    ...
    l = () => {
      ...
      if (((o.style.display = "block"), c > t.maxPages))
        return n.parentNode.removeChild(n), void (o.style.display = "none");
      ...
      r.appendChild(l),
        ((e, t, n) => {
          ...
          a,
          (e) => {
            if (((l.outerHTML = JSON.parse(e)), "enabled" !== t.masonryStatus))
              return !1;
    ...
    u = (e) =>
      "undefined" == typeof wp || void 0 === wp.customize
        ? e
        : ((e +=
            "?customize_changeset_uuid=" +
            wp.customize.settings.changeset.uuid +
            "&customize_autosaved=on"),
          "undefined" == typeof _wpCustomizeSettings
            ? e
            : (e +=
                "&customize_preview_nonce=" +
                _wpCustomizeSettings.nonce.preview)),
      ...
      m(),
        document.addEventListener("click", function (e) {
          e.target.hash &&
            ...
            window.HFG.toggleMenuSidebar(!1);
        }),
        v(),
        g(),
        b(),
    ...
    m = () => {
      const { isRTL: e } = NeveProperties,
        t = document.querySelectorAll(".sub-menu, .minimal .nv-nav-search");
      ...
      t.forEach((t) => {
        ...
        r < 0 &&
          ...
          r + o.width >= n &&
            ((t.style.right = e ? 0 : "100%"), (t.style.left = "auto")),
          (o = t.getBoundingClientRect()),
          (r = o.left),
          (r < 0 || r + o.width >= n) &&
            (t.style.transform =
              "translateX(" + (e ? "-" : "") + (Math.abs(r) + 20) + "px)");
      }),
        "undefined" != typeof menuCalcEvent &&
  ...
  function f(e, n) {
    ...
    t(n, d[0]),
      t(o, d[0]),
      S(document.querySelectorAll(".".concat(d[0])), d[0]);
  }
  const y = (e) =>
    e === document ||
    ("none" !== window.getComputedStyle(e, null).display && y(e.parentNode));
  let w = {};
  function h(e) {
    ...
    r &&
      ...
      w.backFocus.focus(),
      window.HFG.toggleMenuSidebar(!1),
      document.dispatchEvent(new CustomEvent("ftrap-end"))),
      !o && n && c === i && (e.preventDefault(), s.focus()),
      o && n && s === i && (e.preventDefault(), c.focus()),
      n && s === c && e.preventDefault();
  }
  function g() {
  ...
  (C.prototype.init = function (t = !1) {
    ...
    (C.prototype.toggleMenuSidebar = function (e, t = null) {
      ...
      if (
        (!NeveProperties.isCustomize && r.body.classList.contains(E[0])) ||
        !1 === e
      ) {
        ...
        null !== e && e.parentNode.removeChild(e),
          ...
          k(s, !1),
          k(c),
          r.dispatchEvent(new CustomEvent("ftrap-end"));
      } else
        n(r.body, E[0]),
          n(i, E[2]),
          t &&

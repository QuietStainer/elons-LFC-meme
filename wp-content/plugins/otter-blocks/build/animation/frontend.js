!(function () {
  const t = [
    ...
    s = (t) => {
      ...
      return (
        "string" == typeof t
          ? ((t = null !== (e = parseFloat(t)) && void 0 !== e ? e : 0),
  ...
  window.addEventListener("load", () => {
        ...
        (t.id = "o-anim-custom-values"),
          (t.innerHTML =
            e.reduce((t, e) => {
              ...
              return (
                t +
                `.animated.${e} { animation-delay: ${n}; -webkit-animation-delay: ${n}; }`
              );
            }, "") +
            "\n" +
            n.reduce((t, e) => {
              ...
              return (
                t +
                `.animated.${e} { animation-duration: ${n}; -webkit-animation-duration: ${n}; }`
              );
            }, "")),
    ...
    for (const t of d)
      t.animationClasses &&
        ...
        u.push({ element: t, triggerOffset: i(t) });
    window.addEventListener("scroll", () => {
      requestAnimationFrame(() => {
        ...
        for (const e of u) {
          ...
          o + s(a) <= 0.95 * window.innerHeight &&
            0 < o &&
            (n.animationClasses.forEach((t) => n.classList.add(t)),
